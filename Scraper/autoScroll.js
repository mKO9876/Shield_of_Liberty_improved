...
//                     // Check if the scrollHeight has grown after a brief pause
//                     setTimeout(() => {
//                         if (totalHeight >= document.body.scrollHeight) {
//                             clearInterval(timer);
//                             resolve();
//                         }
//                     }, 500); // Wait 500ms for lazy content to "pop"
//                 }
//             }, 150); // Slightly slower to allow network requests to fire/finish
//         });
//     });
// };
